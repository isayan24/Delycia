  ...
  return (
    <div>
      ...
      >
        ...
        <div className={`${isMobile && "hidden"} bg-gradient-to-br from-green-600 to-green-700 text-white`}>
          <div className="max-w-7xl mx-auto px-4 py-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <button onClick={() => window.scrollTo({ top: 500, behavior: "smooth" })} className="bg-green-400 hover:bg-green-300 text-green-900 font-semibold px-8 py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                  Order now
                </button>
              </div>
                ...
                <div className="w-80 h-80 bg-green-500 rounded-3xl mx-auto relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                    <div className="text-6xl">
                      <img src="/images/home-page-cart-pic.jpeg" alt="Grocery bag illustration" className="w-full h-full object-cover" />
                    </div>
                  </div>
                </div>
              </div>
