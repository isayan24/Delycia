...
class ErrorHandlingService {
   ...
   */
  private handleRefreshFailed(_error: AuthError): boolean {
    console.log('Handling refresh failure...')

    // Token refresh is handled by tokenService with deduplication.
    // If we get here, it means refresh truly failed — clear session and redirect.
    sessionService.clearSession()
