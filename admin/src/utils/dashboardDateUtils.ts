...
export type DateFilterType = 'today' | 'yesterday' | 'last7days' | 'lastMonth' | 'thisMonth' | 'allTime' | 'custom';
...
export class DateRangeCalculator {
  ...
  static yesterday(): DateRange {
    ...
    console.log(format(start, 'yyyy-MM-dd'), format(end, 'yyyy-MM-dd'), 'start, end');
