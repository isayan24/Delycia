              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <div className="text-slate-900 dark:text-white">
                    ...
                    <span className="font-[500] text-[15px] max-[500px]:text-[12px]">
                      {item.display_name}
                    </span>
                  </div>
                  {item.addons && (
            ...
            <div className="space-y-6 max-[500px]:space-y-2">
              ...
              <div className="flex gap-4">
                ...
                <Button
                  ...
                  className="flex-2 h-12 max-[500px]:h-10 max-[500px]:text-xs! bg-primary hover:bg-primary/90 text-white font-bold rounded-xl shadow-lg shadow-orange-100 dark:shadow-none transition-all"
                >
                  <CountdownDisplay
