    ...
    return (
      ...
      >
        <div className="flex flex-col lg:flex-row gap-6 max-[500px]:gap-2 items-start lg:items-center">
          {/* Status Icon */}
          <div className="max-[1024px]:hidden! size-14 rounded-xl flex items-center justify-center shrink-0 bg-emerald-50 text-emerald-600 dark:bg-emerald-900/20">
          ...
          <div className="flex-1 space-y-2">
            <div className="flex items-center gap-3">
              <Badge className="bg-emerald-50 text-emerald-600 border-none px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider pointer-events-none">
                Delivered
              </Badge>
            ...
            <div className="pr-4 flex gap-2 items-center">
              ...
              {showCallButton && (
                <Button
                  ...
                  className="h-10 w-10 p-0 max-[500px]:h-4 max-[500px]:w-4 rounded-xl border-none dark:border-primary/10 text-slate-700 dark:text-slate-200 font-bold hover:bg-none dark:hover:bg-slate-800 transition-all flex items-center justify-center"
                >
                  <Phone className="w-4 h-4 text-[#a16b45]" />
                </Button>
              )}
              <div className="text-right">
                <p className="text-sm text-[#a16b45] font-medium mb-1 flex items-center gap-2">
                  Final Total{' '}
                  <span className="text-xl max-[500px]:text-[#a16b45] font-bold text-emerald-600 max-[500px]:text-[14px]!">
                    ₹
    ...
    <div className="space-y-3">
      <div className="bg-white dark:bg-[#2d1e14] rounded-xl border border-[#ead9cd] dark:border-primary/10 overflow-hidden shadow-sm">
        ...
        <div className="bg-slate-50/50 dark:bg-white/5 p-4 space-y-2.5 border-t border-[#ead9cd] dark:border-primary/10">
          ...
          <div className="flex justify-between text-base font-black border-t border-[#ead9cd] dark:border-primary/20 pt-2.5 text-emerald-600">
...
const CustomerInfoSection = memo(({ order }: { order: ProcessedOrder }) => (
  <div className="space-y-4">
    <h4 className="text-sm font-bold uppercase tracking-widest text-[#a16b45]">
      Customer & Location
    </h4>
    <div className="bg-white dark:bg-[#2d1e14] p-6 max-[500px]:p-4 rounded-xl border border-[#ead9cd] dark:border-primary/10 space-y-4 shadow-sm">
      <div className="flex items-center gap-4">
        <div className="size-12 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-lg dark:bg-emerald-900/20">
        ...
        <div>
          ...
          <p className="text-xs text-[#a16b45]">ID: #{order.customer_id}</p>
        </div>
      </div>
      <div className="pt-4 flex flex-col gap-3 border-t border-[#ead9cd] dark:border-primary/10">
        <div className="flex items-center gap-3 text-xs font-semibold text-slate-700 dark:text-slate-200">
          <div className="size-8 rounded-lg bg-orange-50 dark:bg-[#3a291d] flex items-center justify-center text-primary shrink-0">
...
export function DeliveredOrderCard({
  ...
  return (
    <div className="group bg-white dark:bg-[#2d1e14] rounded-xl border border-[#ead9cd] dark:border-primary/10 transition-all overflow-hidden mb-6 max-[500px]:mb-2 shadow-sm! shadow-emerald-200">
      {showThermalBill && (
        <ThermalBill
      ...
      {isExpanded && (
        <div className="border-t border-[#ead9cd] dark:border-primary/10 p-3 bg-background-light/50 dark:bg-background-dark/30 animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-[500px]:gap-2">
            <div className="lg:col-span-2 space-y-6 max-[500px]:space-y-2">
              {globalNote && (
            ...
            <div className="space-y-6 max-[500px]:space-y-2">
              ...
              <div className="bg-white dark:bg-[#2d1e14] p-4 rounded-xl border border-[#ead9cd] dark:border-primary/10 shadow-sm">
                <p className="text-[10px] text-[#a16b45] uppercase font-bold tracking-wider mb-3">
                  Service Details
                </p>
