          ...
          <div className="flex items-center gap-3 divide-x divide-[#ead9cd] dark:divide-primary/10">
            ...
            <div className="pl-6 flex items-center gap-6">
              <div className="text-right">
                ...
                <p className="text-xl font-bold text-emerald-600 max-[500px]:text-lg!">
                  ₹
...
export function DeliveredOrderCard({
  ...
  return (
    <div className="group bg-white dark:bg-[#2d1e14] rounded-xl border border-[#ead9cd] dark:border-primary/10 hover:shadow-xl hover:shadow-primary/5 transition-all overflow-hidden mb-6 max-[500px]:mb-2">
      {showThermalBill && (
        <ThermalBill
