            ...
            <div className="pr-4 flex gap-2 items-center">
              ...
              <div className="text-right">
                <p className="text-sm text-[#a16b45] font-medium mb-1 flex items-center gap-2">
                  Refundable{' '}
                  <span className="text-xl max-[500px]:text-[#a16b45] font-bold text-red-600 max-[500px]:text-[14px]!">
                    ₹
...
export function CancelledOrderCard({ order }: CancelledOrderCardProps) {
  ...
  return (
    <div className="group bg-red-50/30 dark:bg-red-950/5 rounded-xl border border-red-100 dark:border-red-900/10 shadow-sm! shadow-red-200 transition-all overflow-hidden mb-6">
      {showThermalBill && (
        <ThermalBill
