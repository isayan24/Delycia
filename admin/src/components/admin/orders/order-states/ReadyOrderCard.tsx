...
export function ReadyOrderCard({
  ...
  return (
    <div className="group bg-white dark:bg-[#2d1e14] rounded-xl border border-[#ead9cd] dark:border-primary/10 shadow-sm! shadow-blue-300 transition-all overflow-hidden mb-6">
      {showThermalBill && (
        <ThermalBill
