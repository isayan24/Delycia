          ...
          <div className="flex items-center min-w-32">
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5 mb-0.5">
                <Badge className="bg-blue-50 text-blue-600 border-none px-1.5 py-0 text-[13px] font-bold uppercase tracking-tight">
                  Ready
                </Badge>
              ...
              <div className="space-y-1 min-w-0">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-200 truncate flex items-center gap-1.5">
                    <User2 className="w-3.5 h-3.5 text-blue-600 shrink-0" />
            ...
            >
              <td className="py-4 pl-6 pr-4">
                <div className="flex items-start gap-4">
                  <div className="mt-1 shrink-0 text-blue-600/60">
...
export function ReadyOrderCard({
  ...
  return (
    <div className="group bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800/50 hover:border-slate-200 dark:hover:border-slate-700 transition-all duration-300 overflow-hidden shadow-sm hover:shadow-lg hover:shadow-blue-200/50 dark:hover:shadow-none mb-6">
      {showThermalBill && (
        <ThermalBill
            ...
            <div className="border-t border-slate-100 dark:border-slate-800/50 p-6 pt-6 pb-8 bg-white dark:bg-slate-900/10">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-8 space-y-8">
                  ...
                  {/* Ready Specific Actions */}
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 bg-slate-50/50 dark:bg-slate-800/30 p-5 rounded-2xl border border-slate-100 dark:border-slate-800/50">
                    <div className="flex-1 space-y-1.5 min-w-0">
                      <div className="flex items-center gap-2.5 text-[10px] font-bold text-blue-600 uppercase tracking-widest">
                        <PackageCheck className="w-4 h-4" />
                        Delivery Actions
                      </div>
                      <p className="text-[13px] font-medium text-slate-600 dark:text-slate-400 leading-tight">
                        {order.is_delivery
                          ? 'This order is ready for home delivery. Please coordinate with the rider for pickup.'
                    ...
                    <Button
                      ...
                      className="sm:w-auto h-11 px-8 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-sm shadow-emerald-200 dark:shadow-none transition-all flex items-center justify-center gap-2 shrink-0"
                    >
                      <PackageCheck className="w-4 h-4" />
                      {isMarkDelivered ? 'Updating...' : 'Mark Delivered'}
                    </Button>
                  </div>
                </div>
      ...
      {!isExpanded && (
        <div className="px-6 py-3 bg-blue-50/30 dark:bg-blue-900/5 border-t border-slate-100 dark:border-slate-800/50 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <span className="text-[10px] font-bold text-blue-600 dark:text-blue-500 uppercase tracking-widest flex items-center gap-1.5">
              <CheckCircle2 className="w-3.5 h-3.5" /> Waiting for Handover
            </span>
          </div>
          <Button
            variant="ghost"
            ...
            onClick={() => onMarkDelivered(order)}
            disabled={isMarkDelivered}
            className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 p-0 h-auto hover:bg-transparent tracking-widest"
          >
            QUICK DELIVER →
          </Button>
        </div>
