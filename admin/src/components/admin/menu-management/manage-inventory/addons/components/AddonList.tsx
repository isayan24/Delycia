...
export function AddonList({
  ...
  const allSelected = addons.length > 0 && selectedAddons.size === addons.length
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="p-2 rounded-md bg-secondary/50 text-secondary-foreground shrink-0 hidden sm:block">
