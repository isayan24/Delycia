...
const StatItem = ({
  ...
  <div className="flex items-center gap-2 md:gap-4 px-3 md:px-5 lg:px-6 border-slate-100 dark:border-primary/5 min-w-0 py-2.5 md:py-2 border-b border-r last:border-r-0 md:border-b-0 even:border-r-0 md:even:border-r">
    <div
    ...
    <div className="flex flex-col min-w-0 overflow-visible">
      <span className="text-sm md:text-lg lg:text-xl font-black text-slate-900 dark:text-white leading-tight tracking-tight">
        {loading ? (
      ...
      <span className="text-[9px] md:text-[11px]  font-bold text-[#a16b45] uppercase tracking-wider leading-tight whitespace-normal md:whitespace-nowrap">
        {label}
      </span>
    </div>
  </div>
...
export const MiniStats: React.FC<MiniStatsProps> = ({ stats, loading }) => {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 w-full py-1">
      <StatItem
        icon={TrendingUp}
        label="Total Sales"
