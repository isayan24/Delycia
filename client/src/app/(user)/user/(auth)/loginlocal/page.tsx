...
function LocalLogin() {
  ...
  const { showSuccess: ShowSuccess } = useToast();
  ...
  return (
    <div className=" mt-[10rem] flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Login Secretly</CardTitle>
